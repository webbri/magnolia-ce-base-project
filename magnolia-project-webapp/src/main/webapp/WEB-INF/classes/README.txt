...
This package contains:
   ...
   Magnolia Core 6.2.40
   Magnolia empty webapp 6.2.40
   Magnolia empty webapp 6.2.40
   Magnolia Internationalization Framework 6.2.40
   Magnolia JAAS 6.2.40
   Magnolia Mail module 5.6.1
   magnolia-module-rssaggregator 2.6.6
   Magnolia Rendering 6.2.40
   Magnolia Templating 6.2.40
...
More information about this release can be found at:
    http://documentation.magnolia-cms.com/releases/6.2.40.html
